...
class DAGShortestPathTest {
    ...
    void test() {
        ...
        assertIterableEquals(List.of(5, 4, 0), p0.getNodeList());
        ...
        assertIterableEquals(List.of(5, 7, 2), p2.getNodeList());
        ...
        assertIterableEquals(List.of(5, 4), p4.getNodeList());
        ...
        assertIterableEquals(List.of(5, 7), p7.getNodeList());
    }
}